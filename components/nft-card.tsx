...
export function NFTCard({ 
  ...
  return (
    <>
      <Card className="overflow-hidden neon-hover border-primary/20 bg-background/60 rounded-2xl">
        ...
        <CardContent className="p-4">
          <CardTitle className="line-clamp-1 text-gradient neon-text">{name}</CardTitle>
          <Badge variant="outline" className="mt-2 border-secondary/50 text-secondary rounded-lg">
            {collection}
          </Badge>
        </CardContent>
        <CardFooter className="p-4 pt-0 flex justify-between items-center">
          ...
          {!isInUserCollection && (
            <Button 
              ...
              className="bg-primary text-primary-foreground hover:bg-primary/80 neon-hover rounded-xl"
            >
              Acheter
            </Button>
          )}
